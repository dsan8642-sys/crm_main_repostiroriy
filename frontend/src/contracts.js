...
const SAFE_ERROR_MESSAGES = {
  ...
  uk: { auth: 'Сесію завершено. Увійдіть знову.', forbidden: 'У вас немає доступу до цієї дії.', missing: 'Запис не знайдено або він більше недоступний.', invalid: 'Перевірте заповнені поля.', server: 'Сервіс тимчасово недоступний.', network: 'Немає зв’язку із сервером.' },
...
export const PAYMENT_METHODS = Object.freeze([
  { code: 'cash', ru: 'Наличные', uk: 'Готівка', pl: 'Gotówka', en: 'Cash' },
  { code: 'bank_transfer', ru: 'Банковский перевод / IBAN', uk: 'Банківський переказ / IBAN', pl: 'Przelew / IBAN', en: 'Bank transfer / IBAN' },
  { code: 'card', ru: 'Карта', uk: 'Картка', pl: 'Karta', en: 'Card' },
  { code: 'other', ru: 'Другое', uk: 'Інше', pl: 'Inne', en: 'Other' },
])
