...
|---|---|---|
| `IBMPlexSans-Variable.woff2` | `https://raw.githubusercontent.com/IBM/plex/master/packages/plex-sans-variable/fonts/complete/woff2/IBM%20Plex%20Sans%20Var-Roman.woff2` | `E978248B6B56DA9E372975322A98DD9A51135D1B375E32ED6D5CA69F3AAB792D` |
...
PL/EN Latin character sets. The variable Sans face provides weights 100–700;
the UI uses 450, 500 and 600. The UI retains system fallbacks and
`font-display: swap`.
