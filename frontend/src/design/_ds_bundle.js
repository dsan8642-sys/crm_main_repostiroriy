...
(function () {
  const P = (d, size = 18, extra = null) => props => {
    ...
    return React.createElement('svg', {
      ...
      ...(props || {}),
      size: undefined
    }, ...(Array.isArray(d) ? d : [React.createElement('path', {
      key: 'p',
      d
    })]), extra);
  };
  const path = (d, key) => React.createElement('path', {
    key: key || d.slice(0, 6),
    d
  });
  ...
  const line = (x1, y1, x2, y2, key) => React.createElement('line', {
    key: key || 'l' + x1 + y1,
    x1,
    y1,
    x2,
...
function Money({
  ...
  if (signed) {
    if (n < 0) color = 'var(--money-debt)';else if (n > 0) color = 'var(--money-credit)';else color = 'var(--money-zero)';
  }
...
function StatusPill({
  ...
  }), text), showConsumes && consumes && /*#__PURE__*/React.createElement("span", {
    className: "swim-mono",
...
Object.assign(__ds_scope, { Table, thBase, tdBase });
...
function Banner({
  ...
  }, icon || /*#__PURE__*/React.createElement(BannerIcon, {
    tone: tone
...
function Toast({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    viewBox: "0 0 24 24",
    fill: "none"
  }, tone !== 'info' && tone !== 'danger' && /*#__PURE__*/React.createElement("circle", {
    cx: "12",
    cy: "12",
    r: "9",
    stroke: "currentColor",
    strokeWidth: "1.8"
  }), tone === 'danger' && /*#__PURE__*/React.createElement("circle", {
    cx: "12",
    cy: "12",
    r: "9",
    stroke: "currentColor",
...
function Dialog({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, irreversible && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'inline-flex',
      alignItems: 'center',
      gap: 6,
    ...
    style: {
      padding: children ? '16px 20px' : '10px 20px'
    }
...
function Input({
  ...
  }, "*")), hasAffix ? field : /*#__PURE__*/React.createElement("input", _extends({
    id: inputId,
    className: "swim-input",
    style: {
      height: heights[size],
...
function SidebarNav({
  ...
  return /*#__PURE__*/React.createElement("nav", {
  ...
  }, product), roleLabel && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 'var(--fs-2xs)',
      color: 'var(--text-muted)'
    }
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        ...
        padding: '1px 6px',
        borderRadius: 'var(--radius-pill)',
        background: it.countTone === 'danger' ? 'var(--red-500)' : isActive ? 'var(--white)' : 'var(--surface-sunken)',
        color: it.countTone === 'danger' ? '#fff' : isActive ? 'var(--primary-hover)' : 'var(--text-muted)'
      }
    }, it.count));
...
(function () {
  const {
    ...
    Banner,
    Money
  } = window.SwimCRMDesignSystem_546643;
  ...
  function Attendance({
    ...
    const [rows, setRows] = React.useState(D.roster.map(r => ({
      ...r
    })));
    ...
    const markAll = () => {
      setRows(rs => rs.map(r => r.status ? r : {
        ...r,
        status: 'present'
      }));
      setSaved(false);
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      size: 14
    }), " Grafik"), /*#__PURE__*/React.createElement("h2", {
      className: "page-title"
    }, "Delfiny \xB7 17:00\u201317:45"), /*#__PURE__*/React.createElement("p", {
      className: "page-desc"
    }, "Czw 3.07.2026 \xB7 Marek Zieli\u0144ski \xB7 Basen du\u017Cy, tor 3-4")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 8
      }
      ...
      variant: "secondary",
      onClick: markAll
    }, "Zaznacz wszystkich obecnych"), /*#__PURE__*/React.createElement(Button, {
      variant: "primary",
      iconLeft: /*#__PURE__*/React.createElement(I.Check, {
        size: 15
      }),
      onClick: () => setSaved(true)
    }, "Zapisz"))), /*#__PURE__*/React.createElement(Banner, {
      tone: "info",
      style: {
        marginBottom: 14
      }
    }, "Statusy ", /*#__PURE__*/React.createElement("strong", {
      style: {
        color: 'var(--text-strong)'
      }
    }, "Obecny"), " i ", /*#__PURE__*/React.createElement("strong", {
      style: {
        color: 'var(--text-strong)'
      }
    }, "Nieobecny"), " spisuj\u0105 zaj\u0119cie z abonamentu (\u22121). Zmiana statusu tworzy korekt\u0119, nie edytuje starego wpisu."), saved && /*#__PURE__*/React.createElement(Banner, {
      tone: "success",
      style: {
        marginBottom: 14
      },
      onClose: () => setSaved(false)
    }, "Frekwencja zapisana. Utworzono ", rows.filter(r => r.status === 'present' || r.status === 'absent').length, " spisa\u0144."), /*#__PURE__*/React.createElement("div", {
      className: "card",
      style: {
        overflow: 'hidden'
      }
    ...
    }, "Ucze\u0144 (", done, "/", rows.length, " odznaczonych)"), /*#__PURE__*/React.createElement("span", {
      className: "eyebrow",
      style: {
        width: 320
      }
    }, "Status & spisanie")), rows.map((r, i) => /*#__PURE__*/React.createElement("div", {
      key: r.id,
      style: {
        display: 'flex',
        alignItems: 'center',
        ...
        background: r.status ? 'transparent' : 'var(--amber-50)'
      }
    ...
    }, r.name, r.med && /*#__PURE__*/React.createElement("span", {
      title: r.med,
      style: {
        display: 'inline-flex',
        alignItems: 'center',
      ...
      size: 11
    }), r.med)), /*#__PURE__*/React.createElement("div", {
      className: "mono",
      style: {
        fontSize: 'var(--fs-2xs)',
        color: 'var(--text-faint)'
      ...
      return /*#__PURE__*/React.createElement("button", {
        key: o,
        onClick: () => set(r.id, o),
        title: consumes ? 'Spisuje zajęcie (−1)' : 'Nie spisuje',
        style: {
          display: 'inline-flex',
          alignItems: 'center',
          gap: 4,
      ...
      }, LABELS[o], consumes && /*#__PURE__*/React.createElement("span", {
        className: "mono",
        style: {
          fontSize: 'var(--fs-2xs)',
          opacity: on ? 1 : 0.5
...
(function () {
  ...
  function ClientDrawer({
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    }, client.last, " ", client.first), /*#__PURE__*/React.createElement("div", {
      className: "muted",
      style: {
        fontSize: 'var(--fs-xs)'
      }
    }, client.group, " \xB7 ", client.trainer)), /*#__PURE__*/React.createElement(StatusPill, {
      status: client.status,
      size: "sm"
    }), /*#__PURE__*/React.createElement(IconButton, {
      label: "Zamknij",
      onClick: onClose
    }, /*#__PURE__*/React.createElement(I.X, null))), /*#__PURE__*/React.createElement(Tabs, {
      value: tab,
      onChange: setTab,
      style: {
        padding: '0 18px'
    ...
    }, client.med && /*#__PURE__*/React.createElement(Banner, {
      tone: "danger",
      ...
      title: "Dane medyczne"
    }, client.med, " \xB7 Kontakt: ", client.emergency), tab === 'main' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      className: "eyebrow",
      style: {
        marginBottom: 10
      }
    }, "Podstawowe"), /*#__PURE__*/React.createElement("dl", {
      className: "dl",
      style: {
        marginBottom: 20
      }
    }, /*#__PURE__*/React.createElement("dt", null, "Imi\u0119 i nazwisko"), /*#__PURE__*/React.createElement("dd", null, client.first, " ", client.last), /*#__PURE__*/React.createElement("dt", null, "Data urodzenia"), /*#__PURE__*/React.createElement("dd", {
      className: "mono"
    }, client.born), /*#__PURE__*/React.createElement("dt", null, "Grupa"), /*#__PURE__*/React.createElement("dd", null, client.group), /*#__PURE__*/React.createElement("dt", null, "Trener"), /*#__PURE__*/React.createElement("dd", null, client.trainer)), /*#__PURE__*/React.createElement("div", {
      className: "eyebrow",
      style: {
        marginBottom: 10
      }
    }, "Rodzina"), /*#__PURE__*/React.createElement("dl", {
      className: "dl"
    }, /*#__PURE__*/React.createElement("dt", null, "Rodzic"), /*#__PURE__*/React.createElement("dd", null, client.parent), /*#__PURE__*/React.createElement("dt", null, "Telefon rodziny"), /*#__PURE__*/React.createElement("dd", {
      className: "mono"
    }, client.phone), /*#__PURE__*/React.createElement("dt", null, "Email"), /*#__PURE__*/React.createElement("dd", null, client.email))), tab === 'finance' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 20,
        marginBottom: 18
      ...
      className: "eyebrow"
    }, "Saldo"), /*#__PURE__*/React.createElement(Money, {
      amount: client.balance,
      signed: true,
      size: "var(--fs-xl)"
    })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      className: "eyebrow"
    }, "Abonament"), /*#__PURE__*/React.createElement("div", {
      className: "strong"
    }, client.sub)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      className: "eyebrow"
    }, "Koniec"), /*#__PURE__*/React.createElement("div", {
      className: "mono strong"
    }, client.subEnds))), /*#__PURE__*/React.createElement("div", {
      className: "eyebrow",
      style: {
        marginBottom: 8
      }
    }, "Journal ruch\xF3w abonamentu"), /*#__PURE__*/React.createElement("div", {
      className: "card",
      style: {
        marginBottom: 18
      }
    }, [['Zakup 8 zajęć', '+8', '2026-06-20'], ['Obecność · Delfiny', '−1', '2026-06-24'], ['Obecność · Delfiny', '−1', '2026-06-27'], ['Korekta administratora', '+1', '2026-06-28'], ['Obecność · Delfiny', '−1', '2026-07-01']].map((r, i, a) => /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        display: 'flex',
        alignItems: 'center',
      ...
      style: {
        width: 40,
        fontWeight: 600,
        color: r[1][0] === '+' ? 'var(--money-credit)' : 'var(--money-debt)'
      }
    ...
    }, "Nowe naliczenie"), /*#__PURE__*/React.createElement(Button, {
      variant: "secondary",
      size: "sm"
    }, "Dodaj p\u0142atno\u015B\u0107"), /*#__PURE__*/React.createElement(Button, {
      variant: "secondary",
      size: "sm",
      iconLeft: /*#__PURE__*/React.createElement(I.Snowflake, {
        size: 14
      })
    }, "Zamro\u017A"))), tab === 'attendance' && /*#__PURE__*/React.createElement("div", {
      className: "card"
    }, [['2026-07-01', 'present'], ['2026-06-27', 'present'], ['2026-06-24', 'absent'], ['2026-06-20', 'excused'], ['2026-06-17', 'moved']].map((r, i, a) => /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        display: 'flex',
        alignItems: 'center',
    ...
    }, "Delfiny \xB7 17:00"), /*#__PURE__*/React.createElement(StatusPill, {
      status: r[1],
      size: "sm",
      showConsumes: true
    }))))), /*#__PURE__*/React.createElement("div", {
      ...
      variant: "secondary",
      iconLeft: /*#__PURE__*/React.createElement(I.Pencil, {
        size: 14
      })
    }, "Edytuj"), /*#__PURE__*/React.createElement("span", {
      style: {
        flex: 1
      }
    }), /*#__PURE__*/React.createElement(Button, {
      variant: "danger",
      size: "md",
      iconLeft: /*#__PURE__*/React.createElement(I.Shield, {
        size: 14
      }),
      onClick: () => setAnon(true)
    }, "Anonimizuj (RODO)"))), anon && /*#__PURE__*/React.createElement(Dialog, {
      open: true,
      irreversible: true,
      tone: "danger",
  ...
  function Clients() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "page-title"
    }, "Klienci"), /*#__PURE__*/React.createElement("p", {
      className: "page-desc"
    }, D.clients.length, " rodzin \xB7 ", D.clients.filter(c => c.balance < 0).length, " z d\u0142ugiem")), /*#__PURE__*/React.createElement(Button, {
      variant: "primary",
      iconLeft: /*#__PURE__*/React.createElement(I.Plus, {
        size: 15
      })
    }, "Nowe dziecko")), /*#__PURE__*/React.createElement("div", {
      className: "toolbar"
      ...
      items: [{
        ...
        value: 'debtors',
        label: 'Dłużnicy',
        count: D.clients.filter(c => c.balance < 0).length
      }],
      style: {
        border: 'none',
        flex: 'none'
      ...
      placeholder: "Szukaj dziecka, rodzica, telefonu\u2026",
      value: q,
      ...
      value: ""
    }, "Wszystkie grupy"), D.groups.map(g => /*#__PURE__*/React.createElement("option", {
      key: g.id
    }, g.name)))), sel.length > 0 && /*#__PURE__*/React.createElement(Banner, {
      tone: "info",
      style: {
        marginBottom: 12
      },
      action: /*#__PURE__*/React.createElement("div", {
        ...
        size: "sm",
        variant: "subtle"
      }, "Zmie\u0144 grup\u0119"), /*#__PURE__*/React.createElement(Button, {
        size: "sm",
        variant: "subtle"
      }, "Eksport"))
    }, "Zaznaczono ", sel.length, " ", sel.length === 1 ? 'klienta' : 'klientów', "."), /*#__PURE__*/React.createElement(Table, {
      selectable: true,
      selectedIds: sel,
      ...
      rows: rows,
      emptyLabel: "Brak klient\xF3w dla wybranych filtr\xF3w",
      columns: [{
        key: 'name',
        header: 'Dziecko',
        render: c => /*#__PURE__*/React.createElement("span", {
          ...
          className: "strong"
        }, c.last, " ", c.first), c.med && /*#__PURE__*/React.createElement("span", {
          title: "Dane medyczne",
          style: {
            marginLeft: 6,
            color: 'var(--red-500)',
        ...
        header: 'Rodzic',
        muted: true,
        render: c => /*#__PURE__*/React.createElement("span", null, c.parent, /*#__PURE__*/React.createElement("div", {
          className: "mono",
          style: {
            fontSize: 'var(--fs-2xs)',
            color: 'var(--text-faint)'
        ...
        header: 'Abonament',
        muted: true,
        render: c => /*#__PURE__*/React.createElement("span", null, c.sub, c.subLeft != null && /*#__PURE__*/React.createElement("span", {
          className: "mono",
          style: {
            marginLeft: 6,
            color: c.subLeft <= 2 ? 'var(--amber-600)' : 'var(--text-faint)'
          }
        }, "\xB7 ", c.subLeft, " zaj."))
      }, {
        key: 'balance',
        ...
        align: 'right',
        width: 110,
        render: c => /*#__PURE__*/React.createElement(Money, {
          amount: c.balance,
          signed: true
        })
      }, {
    ...
    }), open && /*#__PURE__*/React.createElement(ClientDrawer, {
      client: open,
...
(function () {
  ...
  function Debtors() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "page-title"
    }, "D\u0142u\u017Cnicy"), /*#__PURE__*/React.createElement("p", {
      className: "page-desc"
    }, D.debtors.length, " rodzin \xB7 \u0142\u0105czny d\u0142ug ", /*#__PURE__*/React.createElement("span", {
      style: {
        color: 'var(--money-debt)',
        fontWeight: 600
      }
    }, Math.abs(total).toLocaleString('pl-PL', {
      minimumFractionDigits: 2
    }), " z\u0142"))), /*#__PURE__*/React.createElement(Button, {
      variant: "primary",
      iconLeft: /*#__PURE__*/React.createElement(I.Bell, {
        size: 15
      })
    }, "Wy\u015Blij przypomnienia (", D.debtors.length, ")")), /*#__PURE__*/React.createElement("div", {
      className: "toolbar"
    }, /*#__PURE__*/React.createElement("div", {
      className: "seg"
    }, [['today', 'Dziś'], ['3', '3 dni'], ['7', '7 dni'], ['14', '14 dni'], ['30', '30 dni']].map(([v, l]) => /*#__PURE__*/React.createElement("button", {
      key: v,
      className: v === range ? 'on' : '',
      onClick: () => setRange(v)
      ...
      tone: "danger",
      dot: true
    }, "Przeterminowane naliczenia")), /*#__PURE__*/React.createElement(Table, {
      rows: D.debtors,
      columns: [{
        key: 'child',
        header: 'Dziecko',
        ...
        header: 'Rodzic',
        muted: true,
        render: d => /*#__PURE__*/React.createElement("span", null, d.parent)
      }, {
        key: 'group',
        header: 'Grupa',
        muted: true
        ...
        align: 'right',
        width: 120,
        render: d => /*#__PURE__*/React.createElement(Money, {
          amount: d.balance,
          signed: true
        })
      }, {
...
(function () {
  ...
  function Overview({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "page-title"
    }, "Przegl\u0105d"), /*#__PURE__*/React.createElement("p", {
      className: "page-desc"
    }, "Czwartek, 3 lipca 2026 \xB7 Europe/Warsaw")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 8
      }
      ...
      onClick: () => go('schedule')
    }, "Grafik na dzi\u015B"), /*#__PURE__*/React.createElement(Button, {
      variant: "primary",
      iconLeft: /*#__PURE__*/React.createElement(I.Cash, {
        size: 15
      }),
      onClick: () => go('payments')
    }, "P\u0142atno\u015Bci do sprawdzenia"))), /*#__PURE__*/React.createElement(Banner, {
      tone: "warning",
    ...
    }, "Rodzice przes\u0142ali potwierdzenia przelewu. Sprawd\u017A kwoty przed potwierdzeniem."), /*#__PURE__*/React.createElement("div", {
      className: "eyebrow",
      style: {
        marginBottom: 10
      }
      ...
      label: "Zaj\u0119cia dzi\u015B",
      value: "5",
      sub: "Najbli\u017Csze: Delfiny 17:00"
    }), /*#__PURE__*/React.createElement(Kpi, {
      icon: /*#__PURE__*/React.createElement(I.Whistle, {
        size: 15
      }),
      label: "Trenerzy dzi\u015B",
      value: "2",
    ...
    }, "Finanse"), /*#__PURE__*/React.createElement("div", {
      className: "kpi-grid",
      style: {
        gridTemplateColumns: '1fr 1fr'
      }
    ...
    }, "Abonamenty"), /*#__PURE__*/React.createElement("div", {
      className: "kpi-grid",
      style: {
        gridTemplateColumns: '1fr 1fr'
      }
      ...
      label: "Skoro koniec (7 dni)",
      value: "6",
      sub: "Zaproponuj przed\u0142u\u017Cenie"
    }), /*#__PURE__*/React.createElement(Kpi, {
      ...
      label: "Ma\u0142o zaj\u0119\u0107 (\u22642)",
      value: "3",
      sub: "Filip, Antoni, Zofia"
    })))), /*#__PURE__*/React.createElement("div", {
      className: "eyebrow",
      style: {
        margin: '20px 0 10px'
      }
    }, "Najbli\u017Csze zaj\u0119cia"), /*#__PURE__*/React.createElement("div", {
      className: "card"
    }, D.sessions.filter(s => s.status !== 'done').map((s, i, arr) => /*#__PURE__*/React.createElement("div", {
      key: s.id,
      style: {
        display: 'flex',
        alignItems: 'center',
    ...
    }, s.location), /*#__PURE__*/React.createElement("span", {
      className: "mono muted",
      style: {
        fontSize: 'var(--fs-xs)',
        width: 54,
    ...
    }, s.count, "/", s.limit), /*#__PURE__*/React.createElement(StatusPill, {
      status: s.status,
      size: "sm"
    })))));
  }
...
(function () {
  ...
  function ReceiptDrawer({
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    }, "P\u0142atno\u015B\u0107 ", pay.id.toUpperCase()), /*#__PURE__*/React.createElement("div", {
      className: "muted",
      style: {
        fontSize: 'var(--fs-xs)'
      }
    }, pay.child, " \xB7 ", pay.parent)), /*#__PURE__*/React.createElement(IconButton, {
      label: "Zamknij",
      onClick: onClose
    ...
    }, /*#__PURE__*/React.createElement("dt", null, "Kwota"), /*#__PURE__*/React.createElement("dd", null, /*#__PURE__*/React.createElement(Money, {
      amount: pay.amount
    })), /*#__PURE__*/React.createElement("dt", null, "Spos\xF3b"), /*#__PURE__*/React.createElement("dd", null, pay.method), /*#__PURE__*/React.createElement("dt", null, "Data wp\u0142aty"), /*#__PURE__*/React.createElement("dd", {
      className: "mono"
    }, pay.date), /*#__PURE__*/React.createElement("dt", null, "Zg\u0142osi\u0142"), /*#__PURE__*/React.createElement("dd", null, pay.parent, " (rodzic)")), /*#__PURE__*/React.createElement("div", {
      className: "eyebrow",
      style: {
        marginBottom: 8
      }
    }, "Czek / potwierdzenie"), pay.receipt ? /*#__PURE__*/React.createElement("div", {
      style: {
        border: '1px solid var(--border-default)',
        borderRadius: 'var(--radius-md)',
        overflow: 'hidden'
      ...
      style: {
        height: 200,
        background: 'repeating-linear-gradient(135deg, var(--slate-100), var(--slate-100) 12px, var(--slate-50) 12px, var(--slate-50) 24px)',
        display: 'flex',
        alignItems: 'center',
        justifyContent: 'center',
        color: 'var(--text-faint)'
    ...
    }, pay.receipt), /*#__PURE__*/React.createElement(Button, {
      size: "sm",
      variant: "ghost",
      iconLeft: /*#__PURE__*/React.createElement(I.Download, {
        size: 14
      })
    }, "Pobierz"))) : /*#__PURE__*/React.createElement(Banner, {
      tone: "warning"
    }, "Brak za\u0142\u0105czonego czeku \u2014 p\u0142atno\u015B\u0107 got\xF3wkowa zg\u0142oszona przez administratora.")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 8,
        padding: '12px 18px',
      ...
      fullWidth: true,
      onClick: onReject
    }, "Odrzu\u0107"), /*#__PURE__*/React.createElement(Button, {
      variant: "primary",
      fullWidth: true,
      iconLeft: /*#__PURE__*/React.createElement(I.Check, {
        size: 15
  ...
  function Payments() {
    ...
    const [list, setList] = React.useState(D.payments.map(p => ({
      ...p
    })));
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "page-title"
    }, "P\u0142atno\u015Bci"), /*#__PURE__*/React.createElement("p", {
      className: "page-desc"
    }, "Naliczenia i p\u0142atno\u015Bci s\u0105 rozdzielone. Weryfikuj kwot\u0119 czeku przed potwierdzeniem.")), /*#__PURE__*/React.createElement(Button, {
      variant: "secondary",
      iconLeft: /*#__PURE__*/React.createElement(I.Download, {
        size: 15
      })
    }, "Eksport (XLSX)")), toast && /*#__PURE__*/React.createElement(Banner, {
      tone: "success",
      style: {
        marginBottom: 12
      },
      ...
      columns: [{
        ...
        key: 'receipt',
        header: 'Czek',
        render: p => p.receipt ? /*#__PURE__*/React.createElement("span", {
          style: {
            display: 'inline-flex',
            alignItems: 'center',
            gap: 5,
          ...
          size: 14
        }), " ", p.receipt) : /*#__PURE__*/React.createElement("span", {
          className: "muted",
          style: {
            fontSize: 'var(--fs-xs)'
          }
        ...
        align: 'right',
        width: 110,
        render: p => /*#__PURE__*/React.createElement(Money, {
          amount: p.amount
        })
      }, {
        key: 'status',
        header: 'Status',
        width: 130,
        render: p => /*#__PURE__*/React.createElement(StatusPill, {
          status: p.status,
          size: "sm"
        })
      }, {
        ...
        header: '',
        width: 90,
        render: p => p.status === 'pending' ? /*#__PURE__*/React.createElement("div", {
          className: "row-actions",
          onClick: e => e.stopPropagation()
        }, /*#__PURE__*/React.createElement(IconButton, {
          label: "Potwierd\u017A",
    ...
    }), open && /*#__PURE__*/React.createElement(ReceiptDrawer, {
      pay: open,
      onClose: () => setOpen(null),
      onConfirm: () => confirm(open),
      onReject: () => setReject(open)
    }), reject && /*#__PURE__*/React.createElement(Dialog, {
      open: true,
      tone: "danger",
...
(function () {
  ...
  function Schedule({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "page-title"
    }, "Grafik"), /*#__PURE__*/React.createElement("p", {
      className: "page-desc"
    }, "Widok dnia \xB7 Europe/Warsaw")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 8
      }
    ...
    }, "Indywidualne zaj\u0119cie"), /*#__PURE__*/React.createElement(Button, {
      variant: "primary",
      iconLeft: /*#__PURE__*/React.createElement(I.Layers, {
        size: 15
      })
    }, "Generuj z szablonu"))), /*#__PURE__*/React.createElement("div", {
      className: "toolbar"
    }, /*#__PURE__*/React.createElement("div", {
      className: "seg"
    }, ['Pon 30.06', 'Wt 1.07', 'Śr 2.07', 'Czw 3.07', 'Pt 4.07'].map(d => /*#__PURE__*/React.createElement("button", {
      key: d,
      className: d === day ? 'on' : '',
      onClick: () => setDay(d)
      ...
      tone: "danger",
      dot: true
    }, "1 odwo\u0142ane"), /*#__PURE__*/React.createElement(Badge, {
      tone: "warning",
      dot: true
    }, "1 pe\u0142ne")), /*#__PURE__*/React.createElement(Banner, {
      tone: "warning",
      title: "Uwaga: pe\u0142na grupa",
      style: {
        marginBottom: 14
      }
    }, "Delfiny 17:00 osi\u0105gn\u0119\u0142y limit 12/12 uczestnik\xF3w."), /*#__PURE__*/React.createElement("div", {
      className: "card",
      style: {
        overflow: 'hidden'
      }
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          display: 'flex',
          borderBottom: hi < HOURS.length - 1 ? '1px solid var(--border-subtle)' : 'none',
          minHeight: 62
        }
      }, /*#__PURE__*/React.createElement("div", {
        className: "mono muted",
        ...
        }, s.group), cancelled ? /*#__PURE__*/React.createElement(StatusPill, {
          status: "cancelled",
          size: "sm"
        }) : full ? /*#__PURE__*/React.createElement(Badge, {
          tone: "warning"
        }, s.count, "/", s.limit) : /*#__PURE__*/React.createElement("span", {
          className: "mono muted",
          style: {
            fontSize: 'var(--fs-xs)'
          }
        }, s.count, "/", s.limit)), /*#__PURE__*/React.createElement("div", {
          className: "muted",
          style: {
            fontSize: 'var(--fs-xs)',
            display: 'flex',
        ...
        }, /*#__PURE__*/React.createElement(I.Whistle, {
          size: 13
        }), s.trainer), /*#__PURE__*/React.createElement("span", {
          style: {
            display: 'inline-flex',
        ...
        }, /*#__PURE__*/React.createElement(I.Location, {
          size: 13
        }), s.location)), !cancelled && /*#__PURE__*/React.createElement("div", {
          style: {
            display: 'flex',
            gap: 4,
            marginTop: 3
        ...
        }, "Frekwencja"), /*#__PURE__*/React.createElement(Button, {
          size: "sm",
          variant: "ghost"
        }, "Edytuj"), /*#__PURE__*/React.createElement("span", {
          style: {
...
(function () {
  const trainers = [{
    ...
    phone: '+48 601 220 145',
    active: true,
    groups: 3
  }, {
    id: 't2',
    name: 'Anna Lewandowska',
    phone: '+48 602 118 907',
    active: true,
    groups: 2
  }, {
    id: 't3',
    name: 'Piotr Kaczmarek',
    phone: '+48 605 771 330',
    active: false,
    groups: 1
  }];
  const groups = [{
    ...
    id: 'g4',
    name: 'Żółwie (początkujący)',
    trainer: 'Piotr Kaczmarek',
    students: 6,
    active: false
  }];
  const clients = [{
    ...
    subLeft: 3,
    subEnds: '2026-07-20',
    med: 'Astma — inhalator w torbie',
    emergency: 'Ewa Kowalska · +48 600 100 200'
  }, {
    id: 'c2',
    first: 'Jan',
    last: 'Nowak',
    born: '2014-09-30',
    parent: 'Tomasz Nowak',
    phone: '+48 601 233 991',
    email: 'tnowak@example.pl',
    group: 'Rekiny',
    trainer: 'Anna Lewandowska',
    status: 'active',
    balance: 0,
    ...
    subEnds: '2026-08-04',
    med: '',
    emergency: 'Tomasz Nowak · +48 601 233 991'
  }, {
    id: 'c3',
    first: 'Lena',
    last: 'Wiśniewska',
    born: '2016-01-18',
    parent: 'Marta Wiśniewska',
    phone: '+48 602 550 771',
    email: 'marta.w@example.pl',
    group: 'Foki',
    trainer: 'Marek Zieliński',
    status: 'active',
    balance: 80,
    ...
    subLeft: 5,
    subEnds: '2026-07-28',
    med: 'Alergia na chlor — łagodna',
    emergency: 'Marta Wiśniewska · +48 602 550 771'
  }, {
    id: 'c4',
    first: 'Antoni',
    last: 'Wójcik',
    born: '2015-11-02',
    parent: 'Paweł Wójcik',
    phone: '+48 603 812 400',
    email: 'pwojcik@example.pl',
    group: 'Delfiny',
    trainer: 'Marek Zieliński',
    status: 'active',
    balance: -120,
    ...
    subEnds: '2026-07-08',
    med: '',
    emergency: 'Paweł Wójcik · +48 603 812 400'
  }, {
    id: 'c5',
    first: 'Maja',
    last: 'Kamińska',
    born: '2017-03-25',
    parent: 'Karolina Kamińska',
    phone: '+48 604 119 233',
    email: 'k.kaminska@example.pl',
    group: 'Żółwie (początkujący)',
    trainer: 'Piotr Kaczmarek',
    status: 'inactive',
    balance: 0,
    sub: 'Wygasł',
    ...
    subEnds: '2026-06-10',
    med: '',
    emergency: 'Karolina Kamińska · +48 604 119 233'
  }, {
    id: 'c6',
    first: 'Filip',
    last: 'Zawadzki',
    born: '2014-07-14',
    parent: 'Anna Zawadzka',
    phone: '+48 605 660 187',
    email: 'a.zawadzka@example.pl',
    group: 'Rekiny',
    trainer: 'Anna Lewandowska',
    status: 'active',
    balance: -360,
    ...
    subEnds: '2026-07-11',
    med: 'Cukrzyca typu 1',
    emergency: 'Anna Zawadzka · +48 605 660 187'
  }, {
    id: 'c7',
    first: 'Nadia',
    last: 'Sokołowska',
    born: '2016-10-08',
    parent: 'Robert Sokołowski',
    phone: '+48 606 200 415',
    email: 'r.sokol@example.pl',
    group: 'Foki',
    trainer: 'Marek Zieliński',
    status: 'active',
    balance: 0,
    ...
    subEnds: '2026-09-01',
    med: '',
    emergency: 'Robert Sokołowski · +48 606 200 415'
  }, {
    id: 'c8',
    first: 'Igor',
    last: 'Baran',
    born: '2015-05-19',
    parent: 'Monika Baran',
    phone: '+48 607 341 998',
    email: 'm.baran@example.pl',
    group: 'Delfiny',
    trainer: 'Marek Zieliński',
    status: 'active',
    balance: -80,
    ...
    subEnds: '2026-07-22',
    med: '',
    emergency: 'Monika Baran · +48 607 341 998'
  }];
  ...
  const roster = [{
    ...
    id: 'c9',
    name: 'Hanna Duda',
    phone: '+48 608 190 552',
    status: 'excused',
    med: ''
  }, {
    id: 'c10',
    name: 'Oskar Wróbel',
    phone: '+48 609 771 300',
    status: 'moved',
    med: 'Alergia — orzechy'
  }, {
    id: 'c11',
    name: 'Alicja Mazur',
    phone: '+48 512 004 881',
    status: null,
    med: ''
  }, {
    id: 'c12',
    name: 'Szymon Górski',
    phone: '+48 513 660 240',
    status: null,
    med: ''
  }];
  ...
  const payments = [{
    id: 'p1',
    child: 'Zofia Kowalska',
    parent: 'Ewa Kowalska',
    amount: 240,
    method: 'Przelew',
    date: '2026-07-02',
    status: 'pending',
    receipt: 'przelew_240.pdf'
  }, {
    id: 'p2',
    child: 'Filip Zawadzki',
    parent: 'Anna Zawadzka',
    amount: 360,
    method: 'Przelew',
    date: '2026-07-02',
    status: 'pending',
    receipt: 'blik_pokwitowanie.jpg'
  }, {
    id: 'p3',
    child: 'Igor Baran',
    parent: 'Monika Baran',
    ...
    id: 'p6',
    child: 'Nadia Sokołowska',
    parent: 'Robert Sokołowski',
    amount: 300,
    method: 'Karta',
    date: '2026-06-29',
    status: 'rejected',
    receipt: 'zla_kwota.jpg'
  }];
  ...
  const debtors = [{
    ...
    group: 'Rekiny',
    trainer: 'Anna Lewandowska',
    reason: 'Przeterminowane naliczenie',
    balance: -360,
    last: '2026-05-18'
  }, {
    id: 'c1',
...
(function () {
  ...
  const ledger = {
    k1: [{
      label: 'Zakup — abonament 8 zajęć',
      delta: '+8',
      date: '2026-06-20'
    }, {
      label: 'Obecność · Delfiny',
      delta: '−1',
      date: '2026-06-24'
    }, {
      label: 'Obecność · Delfiny',
  ...
  const charges = [{
    id: 'ch1',
    child: 'Zofia Kowalska',
    desc: 'Abonament 8 zajęć — lipiec',
    amount: 240,
    due: '2026-07-05',
    status: 'overdue'
  }, {
    id: 'ch2',
    child: 'Kacper Kowalski',
    desc: 'Abonament bez limitu — lipiec',
    amount: 300,
    due: '2026-07-10',
    status: 'awaiting'
  }];
...
(function () {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("button", {
        ...
        style: {
          fontSize: 'var(--fs-sm)',
          fontWeight: on ? 600 : 500,
          color: on ? 'var(--primary-hover)' : 'var(--text-body)'
        }
      }, c.name.split(' ')[0]));
    }));
  }
  ...
  function Home({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "page-title"
    }, "Cze\u015B\u0107, Ewa"), /*#__PURE__*/React.createElement("p", {
      className: "page-desc"
    }, "Twoje dzieci w szkole H2O")), /*#__PURE__*/React.createElement(ChildSwitch, {
      kid: kid,
      setKid: setKid
    })), c.balance < 0 && /*#__PURE__*/React.createElement(Banner, {
      tone: "danger",
    ...
    }, c.name, ": saldo ", /*#__PURE__*/React.createElement("strong", null, Math.abs(c.balance), ",00 z\u0142"), ". Prze\u015Blij potwierdzenie przelewu."), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'grid',
        gridTemplateColumns: '1fr 1fr',
        gap: 14
      ...
      size: 15
    })), "Nast\u0119pny trening"), next ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      className: "strong",
      style: {
        fontSize: 'var(--fs-lg)',
        margin: '4px 0 2px'
      }
    }, next.date.replace('Dziś · ', ''), " \xB7 ", next.start), /*#__PURE__*/React.createElement("div", {
      className: "muted",
      style: {
        fontSize: 'var(--fs-sm)'
      }
    }, next.group, " \xB7 ", next.trainer), /*#__PURE__*/React.createElement("div", {
      className: "muted",
      style: {
        fontSize: 'var(--fs-xs)',
        display: 'inline-flex',
      ...
      size: 13
    }), next.location)) : /*#__PURE__*/React.createElement("div", {
      className: "muted",
      style: {
        marginTop: 8
      }
    }, "Brak zaplanowanych zaj\u0119\u0107.")), /*#__PURE__*/React.createElement("div", {
      className: "card card-pad"
    }, /*#__PURE__*/React.createElement("div", {
      className: "kpi-label"
    }, /*#__PURE__*/React.createElement("span", {
    ...
    }, "Pozosta\u0142o: ", /*#__PURE__*/React.createElement("strong", {
      className: "mono",
      style: {
        color: c.subLeft != null && c.subLeft <= 2 ? 'var(--amber-600)' : 'var(--text-strong)'
      }
    }, c.subLeft == null ? '∞' : `${c.subLeft} zaj.`)), /*#__PURE__*/React.createElement("span", {
      className: "muted",
      style: {
        fontSize: 'var(--fs-sm)'
      }
    }, "Koniec: ", /*#__PURE__*/React.createElement("strong", {
      className: "mono"
    }, c.subEnds))), /*#__PURE__*/React.createElement(Button, {
      size: "sm",
      variant: "secondary",
      style: {
        marginTop: 12
    ...
    }, "Zobacz histori\u0119")), /*#__PURE__*/React.createElement("div", {
      className: "card card-pad"
    }, /*#__PURE__*/React.createElement("div", {
      className: "kpi-label"
    }, /*#__PURE__*/React.createElement("span", {
      ...
      size: 15
    })), "P\u0142atno\u015B\u0107"), c.balance < 0 ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      style: {
        margin: '4px 0 2px'
      }
    ...
    }, "Termin: 05.07.2026")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      className: "strong",
      style: {
        fontSize: 'var(--fs-lg)',
        margin: '4px 0 2px',
    ...
    }, "Brak zaleg\u0142o\u015Bci"), /*#__PURE__*/React.createElement("div", {
      className: "muted",
      style: {
        fontSize: 'var(--fs-xs)'
      }
    }, "Wszystko op\u0142acone")), /*#__PURE__*/React.createElement(Button, {
      size: "sm",
      variant: c.balance < 0 ? 'primary' : 'secondary',
      style: {
        marginTop: 12
      },
      ...
      onClick: () => go('payments')
    }, "Prze\u015Blij czek")), /*#__PURE__*/React.createElement("div", {
      className: "card card-pad"
    }, /*#__PURE__*/React.createElement("div", {
      className: "kpi-label"
    }, /*#__PURE__*/React.createElement("span", {
      ...
      size: 15
    })), "Powiadomienia"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 'var(--fs-sm)',
        color: 'var(--text-body)',
        lineHeight: 1.5,
    ...
    }, /*#__PURE__*/React.createElement("div", null, "\xB7 Zaj\u0119cia 9.07 zosta\u0142y ", /*#__PURE__*/React.createElement("strong", null, "odwo\u0142ane"), "."), /*#__PURE__*/React.createElement("div", null, "\xB7 Abonament Zofii ko\u0144czy si\u0119 za ", /*#__PURE__*/React.createElement("strong", null, "3 zaj\u0119cia"), ".")))));
  }
  ...
  function Schedule({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "page-title"
    }, "Rozk\u0142ad"), /*#__PURE__*/React.createElement("p", {
      className: "page-desc"
    }, "Nie mo\u017Cesz sam zapisa\u0107 ani prze\u0142o\u017Cy\u0107 zaj\u0119\u0107 \u2014 skontaktuj si\u0119 z administracj\u0105.")), /*#__PURE__*/React.createElement(ChildSwitch, {
      kid: kid,
      setKid: setKid
    })), /*#__PURE__*/React.createElement("div", {
      className: "card",
    ...
    }, s.trainer, " \xB7 ", s.location), /*#__PURE__*/React.createElement(StatusPill, {
      status: s.status,
      size: "sm"
    })))));
  }
  ...
  function Subscription({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "page-title"
    }, "Abonament"), /*#__PURE__*/React.createElement("p", {
      className: "page-desc"
    }, c.name, " \xB7 ", c.sub)), /*#__PURE__*/React.createElement(ChildSwitch, {
      kid: kid,
      setKid: setKid
    })), /*#__PURE__*/React.createElement("div", {
      style: {
      ...
      className: "eyebrow"
    }, "Pozosta\u0142o zaj\u0119\u0107"), /*#__PURE__*/React.createElement("div", {
      className: "mono",
      style: {
        fontSize: 'var(--fs-3xl)',
        fontWeight: 600,
    ...
    }, c.subLeft == null ? '∞' : c.subLeft)), /*#__PURE__*/React.createElement("div", {
      className: "card card-pad",
      style: {
        flex: 1
      }
      ...
      className: "eyebrow"
    }, "Data ko\u0144ca"), /*#__PURE__*/React.createElement("div", {
      className: "mono",
      style: {
        fontSize: 'var(--fs-xl)',
        fontWeight: 600,
    ...
    }, c.subEnds)), /*#__PURE__*/React.createElement("div", {
      className: "card card-pad",
      style: {
        flex: 1,
        display: 'flex',
      ...
      variant: "primary",
      size: "sm"
    }, "Zg\u0142o\u015B przed\u0142u\u017Cenie"), /*#__PURE__*/React.createElement(Button, {
      variant: "ghost",
      size: "sm"
    }, "Kontakt z administracj\u0105"))), rows.length > 0 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      className: "eyebrow",
      style: {
        marginBottom: 8
      }
    }, "Historia ruch\xF3w \u2014 czytelna: zakup +8, obecno\u015B\u0107 \u22121, korekta +1"), /*#__PURE__*/React.createElement("div", {
      className: "card",
      style: {
        overflow: 'hidden'
      }
      ...
      style: {
        ...
        fontWeight: 600,
        fontSize: 'var(--fs-md)',
        color: r.delta[0] === '+' ? 'var(--money-credit)' : 'var(--money-debt)'
      }
  ...
  function Payments({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "page-desc"
    }, "Naliczenia, historia wp\u0142at i przes\u0142ane czeki")), /*#__PURE__*/React.createElement(Button, {
      variant: "primary",
      iconLeft: /*#__PURE__*/React.createElement(I.Upload, {
        size: 15
      }),
      onClick: () => setUpload(true)
    }, "Prze\u015Blij czek")), /*#__PURE__*/React.createElement(Tabs, {
      value: tab,
      onChange: setTab,
      style: {
        marginBottom: 16
      ...
      items: [{
        value: 'charges',
        label: 'Do zapłaty',
        count: D.charges.length
      }, {
        value: 'history',
        label: 'Historia wpłat'
      }]
    }), tab === 'charges' && /*#__PURE__*/React.createElement("div", {
      className: "card",
      style: {
        overflow: 'hidden'
      }
    }, D.charges.map((ch, i) => /*#__PURE__*/React.createElement("div", {
      key: ch.id,
      style: {
        display: 'flex',
        alignItems: 'center',
        gap: 12,
        padding: '13px 16px',
        borderBottom: i < D.charges.length - 1 ? '1px solid var(--border-subtle)' : 'none'
      }
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 1
    ...
    }, ch.child, " \xB7 termin ", ch.due)), /*#__PURE__*/React.createElement(Money, {
      amount: ch.amount
      ...
      onClick: () => setUpload(true)
    }, "Czek")))), tab === 'history' && /*#__PURE__*/React.createElement("div", {
      className: "card",
      style: {
        overflow: 'hidden'
      }
    }, D.payments.map((p, i) => /*#__PURE__*/React.createElement("div", {
      key: p.id,
      style: {
        display: 'flex',
        alignItems: 'center',
        gap: 12,
        padding: '12px 16px',
        borderBottom: i < D.payments.length - 1 ? '1px solid var(--border-subtle)' : 'none'
      }
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 1
      ...
      className: "strong"
    }, p.child), /*#__PURE__*/React.createElement("div", {
      className: "muted",
      style: {
        fontSize: 'var(--fs-xs)'
      }
    }, p.method, " \xB7 ", p.date)), p.receipt && /*#__PURE__*/React.createElement("span", {
      style: {
        display: 'inline-flex',
        alignItems: 'center',
        gap: 5,
      ...
      size: 14
    }), p.receipt), /*#__PURE__*/React.createElement(Money, {
      amount: p.amount
    }), /*#__PURE__*/React.createElement(StatusPill, {
      status: p.status,
      size: "sm"
      ...
      label: "Dziecko",
      defaultValue: "Zofia Kowalska"
    }, /*#__PURE__*/React.createElement("option", null, "Zofia Kowalska"), /*#__PURE__*/React.createElement("option", null, "Kacper Kowalski")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 10
      }
      ...
      label: "Spos\xF3b p\u0142atno\u015Bci",
      defaultValue: "Przelew"
    }, /*#__PURE__*/React.createElement("option", null, "Przelew"), /*#__PURE__*/React.createElement("option", null, "Got\xF3wka"), /*#__PURE__*/React.createElement("option", null, "Karta")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      style: {
        font: 'var(--text-label)',
        color: 'var(--text-body)',
        marginBottom: 5
      }
    }, "Plik (PDF / JPG / PNG)"), /*#__PURE__*/React.createElement("label", {
      style: {
        display: 'flex',
        flexDirection: 'column',
        alignItems: 'center',
        gap: 6,
        padding: '18px',
        border: `1.5px dashed ${file ? 'var(--primary)' : 'var(--border-strong)'}`,
        borderRadius: 'var(--radius-md)',
        background: file ? 'var(--primary-soft)' : 'var(--surface-sunken)',
        cursor: 'pointer',
        color: 'var(--text-muted)'
      }
    ...
    }, file ? file : 'Kliknij lub przeciągnij plik'), /*#__PURE__*/React.createElement("input", {
      type: "file",
      style: {
        display: 'none'
      },
      onChange: e => setFile(e.target.files[0] ? e.target.files[0].name : 'przelew.pdf')
    }))), /*#__PURE__*/React.createElement(Banner, {
      tone: "info"
    }, "P\u0142atno\u015B\u0107 online nie jest dost\u0119pna. Administrator zweryfikuje czek i potwierdzi wp\u0142at\u0119."))));
  }
  ...
  function Consents({
    ...
    const ITEMS = [['rodo', 'Przetwarzanie danych (RODO)', 'Wymagane do korzystania ze szkoły. Wycofanie: skontaktuj się z administracją.', true], ['email', 'Powiadomienia e-mail', 'Przypomnienia o zajęciach i płatnościach.'], ['sms', 'Powiadomienia SMS', 'Tylko krytyczne sytuacje (odwołane zajęcia).'], ['tg', 'Powiadomienia Telegram', 'Połączony czat: @ewa_k.']];
    return /*#__PURE__*/React.createElement("div", {
      className: "page",
      style: {
        maxWidth: 680
      ...
      className: "page-title"
    }, "Zgody i powiadomienia"), /*#__PURE__*/React.createElement("p", {
      className: "page-desc"
    }, "Zarz\u0105dzasz kana\u0142ami kontaktu i zgodami RODO"))), /*#__PURE__*/React.createElement("div", {
      className: "card"
    }, ITEMS.map(([k, title, desc, req], i) => /*#__PURE__*/React.createElement("div", {
      key: k,
      style: {
        display: 'flex',
        alignItems: 'flex-start',
    ...
    }, title, req && /*#__PURE__*/React.createElement(Badge, {
      tone: "neutral"
    }, "Wymagane")), /*#__PURE__*/React.createElement("div", {
      className: "muted",
      style: {
        fontSize: 'var(--fs-xs)',
        marginTop: 3
    ...
    }, "Wersja polityki prywatno\u015Bci: 2.1 \xB7 zgoda udzielona 2026-01-14"));
  }
...
(function () {
  ...
  const roster = [{
    ...
    id: 'c9',
    name: 'Hanna Duda',
    emergency: 'Robert Duda · +48 608 190 552',
    med: '',
    status: null
  }, {
    id: 'c10',
    name: 'Oskar Wróbel',
    emergency: 'Julia Wróbel · +48 609 771 300',
    med: 'Alergia — orzechy',
    status: null
  }, {
    id: 'c11',
    name: 'Alicja Mazur',
    emergency: 'Piotr Mazur · +48 512 004 881',
    med: '',
    status: null
  }, {
    id: 'c12',
    name: 'Szymon Górski',
    emergency: 'Ewa Górska · +48 513 660 240',
    med: '',
    status: null
  }];
  const groups = [{
    ...
    students: 12,
    next: 'Dziś 17:00',
    schedule: 'Pon, Śr, Czw · 17:00'
  }, {
    id: 'g3',
    name: 'Foki',
    students: 8,
    next: 'Dziś 16:00',
    schedule: 'Wt, Czw · 16:00'
  }, {
    id: 'g5',
    name: 'Wieloryby',
    students: 10,
...
(function () {
  ...
  function Sessions({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "page-title"
    }, "Moje zaj\u0119cia"), /*#__PURE__*/React.createElement("p", {
      className: "page-desc"
    }, "Marek Zieli\u0144ski \xB7 widzisz tylko swoje zaj\u0119cia")), /*#__PURE__*/React.createElement("div", {
      className: "seg"
    }, [['today', 'Dziś'], ['week', 'Tydzień'], ['all', 'Wszystkie']].map(([v, l]) => /*#__PURE__*/React.createElement("button", {
      key: v,
      className: v === range ? 'on' : '',
      onClick: () => setRange(v)
    }, l)))), Object.entries(grouped).map(([date, items]) => /*#__PURE__*/React.createElement("div", {
      key: date,
      style: {
        marginBottom: 18
      }
      ...
      size: 13
    }), s.count), /*#__PURE__*/React.createElement(StatusPill, {
      status: s.status,
      size: "sm"
    }), s.status !== 'cancelled' && /*#__PURE__*/React.createElement(Button, {
      size: "sm",
      variant: s.status === 'done' ? 'ghost' : 'subtle',
      onClick: () => go('session')
    }, s.status === 'done' ? 'Podgląd' : 'Frekwencja')))))));
  }
  ...
  function Session({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      size: 14
    }), " Moje zaj\u0119cia"), /*#__PURE__*/React.createElement("h2", {
      className: "page-title"
    }, "Delfiny \xB7 17:00\u201317:45"), /*#__PURE__*/React.createElement("p", {
      className: "page-desc"
    }, "Czw 3.07 \xB7 Basen du\u017Cy, tor 3-4 \xB7 ", rows.length, " uczni\xF3w")), /*#__PURE__*/React.createElement(Button, {
      variant: "primary",
      iconLeft: /*#__PURE__*/React.createElement(I.Check, {
        size: 15
      }),
      onClick: () => setSaved(true)
    }, "Zapisz frekwencj\u0119")), /*#__PURE__*/React.createElement(Banner, {
      tone: "info",
      style: {
        marginBottom: 14
      }
    ...
    }, "Nieobecny"), " spisuj\u0105 zaj\u0119cie (\u22121). Nie przed\u0142u\u017Casz abonament\xF3w ani nie zmieniasz p\u0142atno\u015Bci."), saved && /*#__PURE__*/React.createElement(Banner, {
      tone: "success",
      style: {
        marginBottom: 14
      },
      onClose: () => setSaved(false)
    }, "Frekwencja zapisana (", done, "/", rows.length, ")."), /*#__PURE__*/React.createElement("div", {
      className: "card",
      style: {
        overflow: 'hidden'
      }
      ...
      size: 11
    }), "Kontakt: ", r.emergency)), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 4
      }
  ...
  function Groups() {
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "page-title"
    }, "Moje grupy"), /*#__PURE__*/React.createElement("p", {
      className: "page-desc"
    }, D.groups.length, " grupy przypisane do Ciebie"))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'grid',
    ...
    }, /*#__PURE__*/React.createElement(I.Waves, {
      size: 18
    })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      className: "strong",
      style: {
    ...
    }, g.students, " uczni\xF3w"))), /*#__PURE__*/React.createElement("dl", {
      className: "dl",
      style: {
        gridTemplateColumns: '92px 1fr'
      }
    }, /*#__PURE__*/React.createElement("dt", null, "Grafik"), /*#__PURE__*/React.createElement("dd", {
      style: {
        fontWeight: 500
      }
    }, g.schedule), /*#__PURE__*/React.createElement("dt", null, "Najbli\u017Csze"), /*#__PURE__*/React.createElement("dd", null, /*#__PURE__*/React.createElement(Badge, {
      tone: "primary",
      dot: true
    }, g.next)))))));
  }
  window.TrainerScreens = {
    Sessions,
    Session,
    Groups
  };
